...
public class JalanApiURLCreator implements Serializable {
	...
	public final String areaSearchUrl = "http://jws.jalan.net/APICommon/AreaSearch/V1/?key=********";
	public final String hotelSearchUrl = "http://jws.jalan.net/APIAdvance/HotelSearch/V1/?key=*******";
	...
	// ÇªÇÃëºåüçıèåè
	public static final String[] optionKey = { "&stay_date=", "&stay_count=", "&room_count=", "&adult_num=", "&sc_num=", "&lc_num_bed_meal=", "&lc_num_meal_only=", "&lc_num_bed_only=", "&lc_num_no_bed_meal=", "&min_rate=", "&max_rate=", "&h_type=" };

	public static final String[] optionSelectedKey = { "&room_b=", "&room_d=", "&prv_b=", "&prv_d=", "&early_in=", "&late_out=", "&pub_bath=", "&prv_bath=", "&v_bath=", "&onsen=", "&o_bath=", "&cloudy=", "&pour=", "&sauna=", "&esthe=", "&mssg=", "&jacz=", "&o_pool=", "&i_pool=", "&fitness=", "&gym=", "&p_field=", "&r_ski=", "&r_brd=", "&p_pong=", "&hall=", "&bbq=", "&parking=", "&pet=", "&limo=", "&no_smk=", "&net=", "&r_room=", "&high=", "&sp_room=", "&bath_to=", "&5_station=", "&5_beach=", "&5_slope=", "&cvs=", "&no_meal=", "&b_only=", "&d_only=", "&2_meals=", "&sng_room=", "&twn_room=", "&dbl_room=", "&tri_room=", "&4bed_room=", "&jpn_room=", "&j_w_room=", "&child_price=", "&c_sc=", "&c_bed_meal=", "&c_no_bed_meal=", "&c_meal_only=", "&c_bed_only=" };

	public static final String[] optionCard = { "&c_card=", "&c_jcb=", "&c_visa=", "&c_master=", "&c_amex=", "&c_uc=", "&c_dc=", "&c_nicos=", "&c_diners=", "&c_saison=", "&c_ufj=" };
